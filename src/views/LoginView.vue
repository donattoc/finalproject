    ...
    signInWithEmailAndPassword(this.auth!, this.u_email, this.u_pass)
      .then(async (cr: UserCredential) => {
        if (cr.user.emailVerified)
          this.$router.push({ name: "profile", params: { byWayOf: "Email" } });
        else {
  ...
  withGMail(): void {
    ...
    signInWithPopup(this.auth!, provider)
      .then((cred: UserCredential) => {
        ...
        this.$router.push({ name: "profile", params: { byWayOf: "Google" } });
      })
      .catch((err: any) => {
  ...
  withGitHub(): void {
    ...
    signInWithPopup(this.auth!, provider)
      .then((cred: UserCredential) => {
        ...
        // Move to the home page
        this.$router.push({ name: "profile", params: { byWayOf: "GitHub" } });
      })
      .catch((err: any) => {
